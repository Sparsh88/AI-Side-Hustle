...
export const chatWithBot = async ({ message, history }) => {
  ...
  try {
    ...
    // Fallback Mock Data
    return {
      reply: "I'm currently running in offline mode, but I'm here to help! The AI Side Hustle Finder matches your skills and interests with the best side hustles. Try entering your details on the homepage to get started!"
    };
  }
};
